    ...
    with open(os.path.join(sys.path[0], "user.bin"), "rb+") as f:
        ...
        if input_bin_hash == '79b695a73fd5ff22cbfeb4b83908ab29': #CR-V thanks to joe1
            ...
            data_new = [
                ...
                '0x0000, 0x02BA, 0x06BA, 0x0B00, 0x0EB3, 0x10BE, 0x1200, 0x48FD, 0x7FFA', # new torque_table row 1
                '0x0000, 0x02CA, 0x065D, 0x0ABA, 0x0DC2, 0x0F80, 0x1033, 0x48FD, 0x7FFA', # new torque_table row 2
                '0x0000, 0x0300, 0x0680, 0x0980, 0x0C4D, 0x0E80, 0x0F00, 0x48FD, 0x7FFA', # new torque_table row 3
                '0x0000, 0x0746, 0x0B04, 0x0CDF, 0x0E19, 0x1008, 0x1200, 0x48FD, 0x7FFA', # new torque_table row 4
                '0x0000, 0x0746, 0x0B04, 0x0CDF, 0x0E19, 0x1008, 0x1200, 0x48FD, 0x7FFA', # new torque_table row 5
                '0x0000, 0x0746, 0x0B04, 0x0CDF, 0x0E19, 0x1008, 0x1200, 0x48FD, 0x7FFA', # new torque_table row 6
                '0x0000, 0x06B3, 0x0B1A, 0x0CCD, 0x0E9A, 0x104D, 0x352C, 0x5A0C, 0x7EEC', # new torque_table row 7
