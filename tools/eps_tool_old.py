    ...
    with open(os.path.join(sys.path[0], "user.bin"), "rb+") as f:
        ...
        if input_bin_hash == '79b695a73fd5ff22cbfeb4b83908ab29': #CR-V thanks to joe1
            ...
            data_new = [
                ...
                '0x0000, 0x0B40, 0x1680, 0x21C0, 0x2D00, 0x3840, 0x4380, 0x4EC0, 0x5A00', # new torque_table row 1
                '0x0000, 0x0B40, 0x1680, 0x21C0, 0x2D00, 0x3840, 0x4380, 0x4EC0, 0x5A00', # new torque_table row 2
                '0x0000, 0x0B40, 0x1680, 0x21C0, 0x2D00, 0x3840, 0x4380, 0x4EC0, 0x5A00', # new torque_table row 3
                '0x0000, 0x0B40, 0x1680, 0x21C0, 0x2D00, 0x3840, 0x4380, 0x4EC0, 0x5A00', # new torque_table row 4
                '0x0000, 0x0B40, 0x1680, 0x21C0, 0x2D00, 0x3840, 0x4380, 0x4EC0, 0x5A00', # new torque_table row 5
                '0x0000, 0x0B40, 0x0DC5, 0x21C0, 0x2D00, 0x3840, 0x4380, 0x4EC0, 0x5A00', # new torque_table row 6
                '0x0000, 0x08ED, 0x11DA, 0x1AC7, 0x23B4, 0x2CA1, 0x358E, 0x3E7B, 0x4768', # new torque_table row 7

                '0x009f, 0x0120, 0x0240, 0x0360, 0x0480, 0x05A0, 0x06C0, 0x07E0, 0x0900', # filter_table row 1
                '0x009f, 0x0120, 0x0240, 0x0360, 0x0480, 0x05A0, 0x06C0, 0x07E0, 0x0900', # filter_table row 2
                '0x009f, 0x0120, 0x0240, 0x0360, 0x0480, 0x05A0, 0x06C0, 0x07E0, 0x0900', # filter_table row 3
                '0x009f, 0x0120, 0x0240, 0x0360, 0x0480, 0x05A0, 0x06C0, 0x07E0, 0x0900', # filter_table row 4
                '0x009f, 0x0120, 0x0240, 0x0360, 0x0480, 0x05A0, 0x06C0, 0x07E0, 0x0900', # filter_table row 5
                '0x009f, 0x0120, 0x0240, 0x0360, 0x0480, 0x05A0, 0x06C0, 0x07E0, 0x0900', # filter_table row 6
                '0x009f, 0x0120, 0x0240, 0x0360, 0x0480, 0x05A0, 0x06C0, 0x07E0, 0x0900', # filter_table row 7
                ]
            data_label = [
                'speed_clamp_lo',
